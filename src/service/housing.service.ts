...
class HousingService {
    ...
    public async getUsingSearchQuery(
        cityName: string,
        minDistInMin: number,
        maxDistInMin: number,
        pageNum: number,
        ...
        const totalPages = await this.housingDAO.getCountOfSearchQuery(cityId, minDistInKM, maxDistInKM);
        return { results: removeBulkURLs(housing), totalPages };
    }
